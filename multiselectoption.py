...
#     combobox1 = ttkkss.Combobox(main,values=tb)
#     combobox1.pack()

#     combobox = Combopicker(main, values= tb )
#     combobox.pack()
    

#     button1 = ttk.Button(root, text="RUN",command=print_selection)
#     button1.pack()
#     root.mainloop()
